...
public class CollectionsUtil {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> nums = Arrays.asList(12,1,22,33,5,5,5,5,44,55);
        System.out.println("nums = " + nums);
        Collections.reverse(nums);
        System.out.println(":After reverse it = " + nums);
        ...
        System.out.println("countOfOne = " + countOfOnes);

        Collections.replaceAll(nums, 5, 50);
        System.out.println("after replace = " + nums);
